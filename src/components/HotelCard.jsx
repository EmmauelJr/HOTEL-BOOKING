...
const HotelCard = ({room, index}) => {
  return (
    ...
    max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 
    shadow-[0px_4px_4px_rgba(0,0,0,0.05)]'>
        ...
        <div className='p-4 pt-5'>
            <div className='flex items-center justify-between'>
                <p className='font-merriweather text-xl font-medium text-gray-800'>
                    {room.hotel.name}
                </p>
                <div className='flex items-center gap-1'>
                    <img src={assets.starIconFilled} alt="star-icon-filled" /> 4.5
                </div>
            </div>
